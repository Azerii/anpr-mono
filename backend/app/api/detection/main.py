...
class LicensePlateRecognition:
    ...
    def __init__(self, ws: WebSocket):
        ...
        # self.car_detector = YOLO('yolov8s.pt', task='detect')
        ...
        # Create tasks for video stream and car recognition
        # self.video_stream_task = asyncio.create_task(self.video_stream())
        # self.car_recognition_task = asyncio.create_task(self.car_recognition())
    ...
    async def main(self):
        ...
        await asyncio.gather(self.video_stream_task, self.car_recognition_task)
    ...
    async def car_recognition(self):
        while self.running:
            ...
            for detection in detections.boxes.data.tolist():
                ...
                if license_plate_text is not None:
                    ...
                    encoded_frame = cv2.imencode('.jpg', frame)[1].tobytes()
                    base64_encoded_frame = base64.b64encode(encoded_frame).decode('utf-8')
                    await self.websocket.send_json({"frame": base64_encoded_frame, "detection": license_plate_text})
